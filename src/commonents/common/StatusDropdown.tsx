...
const StatusDropdown: React.FC<StatusDropdownProps> = ({ value, onChange }) => {
  return (
    <select
      ...
      className="block w-32 px-4 py-2 mt-1 rounded-lg bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-md hover:pinter bg-indigo-100"
    >
